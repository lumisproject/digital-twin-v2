  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      try {
        ...
        // Check if ingestion just finished
        if (data.status === 'completed') {
            ...
            // Fetch fresh risks generated by the predictive engine
            const riskRes = await fetch(`http://localhost:5000/api/risks/${projectData.id}`);
            const riskData = await riskRes.json();
            if (riskData.status === 'success') setRisks(riskData.risks);
                ...
                <div key={i} className="risk-card">
                    <div className="risk-header">
                      ...
                      <span className="risk-badge" style={{ 
                        background: r.severity === 'High' ? '#ef4444' : '#f59e0b' 
                      }}>{r.severity}</span>
                    </div>
                    <div className="risk-desc">
                      {/* Use Markdown to render the technical analysis correctly */}
